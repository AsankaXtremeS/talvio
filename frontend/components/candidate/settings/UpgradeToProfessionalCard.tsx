      ...
      <section className="rounded-xl border border-[#E4E8F2] bg-white p-5 shadow-sm">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-full bg-green-50 flex items-center justify-center shrink-0">
            <CheckCircle2 className="text-green-700 w-[18px] h-[18px]" />
          </div>
          <div>
            <h2 className="text-[15px] font-semibold text-[#111827] leading-tight">Account upgraded!</h2>
            <p className="text-xs text-[#6B7280]">Professional account</p>
          </div>
        </div>
        <div className="border-t border-[#F0F0F0] my-3" />
        <p className="text-sm text-[#6B7280] leading-relaxed">
          You are now a professional candidate. Enjoy full access to job features and opportunities!
        </p>
        <div className="mt-3 bg-green-50 rounded-lg px-3 py-2">
          <p className="text-sm font-medium text-green-800">All features unlocked</p>
        </div>
      </section>
    );
  }
