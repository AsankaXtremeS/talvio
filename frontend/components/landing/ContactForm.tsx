...
const countryCodes = ["+94", "+1", "+44", "+91", "+61", "+49", "+33", "+81"];
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div
              style={{
                ...
                gap: 0,
                marginBottom: 14,
                border: `1.5px solid ${focused === "phone" ? "#4f6ef7" : "#e2e5f0"}`,
                borderRadius: 30,
                overflow: "hidden",
                background: "#fff",
                transition: "border-color 0.2s",
              ...
              <div style={{ position: "relative" }}>
                <button
                  ...
                  style={{
                    ...
                    background: "none",
                    border: "none",
                    borderRight: "1.5px solid #e2e5f0",
                    cursor: "pointer",
                    fontSize: 14,
                    fontWeight: 600,
                    color: "#1a1f36",
                    ...
                    {countryCodes.map((code) => (
                      <button
                        ...
                        style={{
                          ...
                          padding: "9px 16px",
                          textAlign: "left",
                          background: form.countryCode === code ? "#f0f4ff" : "#fff",
                          border: "none",
                          cursor: "pointer",
                          fontSize: 14,
                          fontWeight: 500,
            ...
            <button
              ...
              style={{
                ...
                padding: "15px",
                borderRadius: 30,
                background: "linear-gradient(135deg,#4f6ef7 0%,#5b7cf7 100%)",
                color: "#fff",
                fontSize: 15,
                fontWeight: 700,
                border: "none",
            ...
            >
              ...
              <a
                ...
                style={{ color: "#4f6ef7", fontWeight: 600, textDecoration: "none" }}
