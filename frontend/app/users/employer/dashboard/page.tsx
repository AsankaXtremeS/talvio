...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-1 min-h-screen bg-[#FAFAFA] overflow-auto p-7 [&_button:not(:disabled)]:cursor-pointer">
      <div className="sticky top-0 z-30 bg-[#FAFAFA] pt-0 -mt-7 pb-2">
        ...
        <div className="sticky top-22 z-20 bg-[#FAFAFA] pb-2">
          <StatsRow />
        </div>
      </div>
